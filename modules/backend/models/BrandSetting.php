...
class BrandSetting extends Model
{
    ...
    public static function getBackground()
    {
        ...
        if ($settings->background) {
            return $settings->background->getPath();
        }

        return self::getDefaultBackground() ?: null;
    }
    ...
    public static function getSide()
    {
        ...
        if ($settings->side) {
            return $settings->side->getPath();
        }

        return self::getDefaultSide() ?: null;
    }
    ...
    {
        $backgroundPath = Config::get('storage.media.path', '/storage/app/media') . '/defaults/background.jpg';
    ...
    public static function getDefaultSide()
    {
        $sidePath = Config::get('storage.media.path', '/storage/app/media') . '/defaults/side.png';
