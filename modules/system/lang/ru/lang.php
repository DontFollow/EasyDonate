...
return [
    ...
    'plugins'        => [
        ...
        'remove_confirm'          => 'Вы уверены, что хотите удалить выбранные плагины? Это также удалит все связанные данные.',
        'remove_success'          => 'Выбранные плагины успешно удалены.',
        'refresh_confirm'         => 'Вы уверены, что хотите сбросить данные у выбранных плагинов? Данное действие восстановит их в исходное состояние',
        ...
        'freeze'                  => 'отключить обновления',
        'unfreeze'                => 'включить обновления',
        'enable'                  => 'включить',
        'disable'                 => 'отключить',
