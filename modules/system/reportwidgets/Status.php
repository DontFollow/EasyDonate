...
class Status extends ReportWidgetBase
{
    ...
    protected function loadData()
    {
        ...
        $credentials = http_build_query(config('credentials'));

        try {
            $updates = file_get_contents(implode('?', [$url, $credentials]));
    ...
    protected function getSystemWarnings()
    {
        ...
        //         $warnings[] = "Не удалось получить информацию о сервере <b>{$server->name}</b>. Проверьте настройки <b>query</b> в <b>server.properties</b>";
        //     }
        // }
