...
class ServiceProvider extends ModuleServiceProvider
{
    ...
    protected function registerConsole()
    {
         ...
         */
        $this->registerConsoleCommand('easy.up', 'System\Console\OctoberUp');
        $this->registerConsoleCommand('easy.down', 'System\Console\OctoberDown');
        $this->registerConsoleCommand('easy.update', 'System\Console\OctoberUpdate');
        $this->registerConsoleCommand('easy.util', 'System\Console\OctoberUtil');
        $this->registerConsoleCommand('easy.mirror', 'System\Console\OctoberMirror');
        $this->registerConsoleCommand('easy.fresh', 'System\Console\OctoberFresh');
        $this->registerConsoleCommand('easy.env', 'System\Console\OctoberEnv');
        $this->registerConsoleCommand('easy.init', 'System\Console\OctoberInit');
